...
echo "=== DIRECT GET /api/participants (Port 8084) ==="
curl -s -H "Authorization: Bearer $TOKEN" http://localhost:8084/api/participants

echo ""
echo "=== DIRECT GET /api/enrollments (Port 8084) ==="
curl -s -H "Authorization: Bearer $TOKEN" http://localhost:8084/api/enrollments
